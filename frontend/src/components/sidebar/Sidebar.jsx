...
const icons = {
    ...
    'Report Analysis': <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18"/><path d="m18 9-6 6-4-4-5 5"/></svg>, // TrendingUp
...
const sidebarData = {
    Reports: [
        ...
        { name: 'Report Analysis', path: '/reports/analysis', icon: icons['Report Analysis'] },
    ],
    DietPlans: [
