  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const errorMessage = result.message || 'An unexpected error occurred during upload.';
    ...
    return (
        <div className="upload-report-container">
            ...
            <p className="upload-report-description">
                Securely upload your medical reports (PDF, JPG, PNG) to Cloudinary.
            </p>
            ...
            <form onSubmit={handleUpload} className="upload-form">
                ...
                <div className="form-group">
                    ...
                    />
                    {file && (
                        <p className="file-info">Selected: <strong>{file.name}</strong> ({Math.round(file.size / 1024)} KB)</p>
                    )}
                </div>
